...
export class Init1769732215760 implements MigrationInterface {
    name = 'Init1769732215760'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "laboratorio" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "address" character varying NOT NULL, "phone" character varying NOT NULL, "horario" character varying NOT NULL, "province_id" integer, CONSTRAINT "PK_0da9d571d9f912a3329aa4bdbda" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "city" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "zip_code" character varying, "province_id" integer NOT NULL, "laboratorio_id" integer, CONSTRAINT "PK_b222f51ce26f7e5ca86944a6739" PRIMARY KEY ("id"))`);
